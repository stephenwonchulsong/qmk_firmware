// for flashing:
// bin/fp_build.sh -k ffkb_byomcu/v3 -m 1tegsvenson -i -c stemcell -r
...
[_QWERTY] = LAYOUT_ffkb(
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                KC_LALT, LOWER,    GUIDEL,  KC_BTN1,   KC_BTN2, KC_SPC, RAISECAPS,  KC_CAPS
                            //`|--------+--------+--------+--------|'`|--------+--------+--------+--------|'
),
...
[_LOWER] = LAYOUT_ffkb(
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     GUIGRV,   _______, _______, _______, W1R,     PHONE_1,                      _______, LALT(LSFT(KC_LEFT)), LALT(LSFT(KC_UP)), LALT(LSFT(KC_DOWN)), LALT(LSFT(KC_RIGHT)), _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______,  KC_VOLD, KC_VOLU, KC_MUTE, CAPTURE, _______,                      _______, _______, KC_LBRC, KC_RBRC, _______, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
[_RAISE] = LAYOUT_ffkb(
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______, _______, _______, _______, KC_PGUP, _______,                      _______, KC_LEFT,  KC_UP,  KC_DOWN, KC_RIGHT, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______, _______, _______, _______, KC_PGDN, KC_BSLS,                      _______, _______, KC_LCBR, KC_RCBR, _______, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                _______, _______, _______, _______,     _______, _______, _______, _______
                            //`|--------+--------+--------+--------|'`|--------+--------+--------+--------|'
),
...
[_ADJUST] =  LAYOUT_ffkb(
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______, _______, _______, _______, _______, TO(_QWERTY),                  _______, LALT(KC_LEFT), LALT(KC_UP), LALT(KC_DOWN), LALT(KC_RIGHT), _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     QK_BOOTLOADER, _______, _______, _______, _______, TO(_MIRYOKU),           _______, _______, KC_LABK, KC_RABK, _______, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                _______, _______, _______, _______,     _______, _______, _______, _______
                            //`|--------+--------+--------+--------|'`|--------+--------+--------+--------|'
),
...
[_SHIFT] = LAYOUT_ffkb(
  ...
  [_EXTRA] = LAYOUT_ffkb(
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
     _______, MACNTAB, MACCLOSE, MACPTAB, M_TAB_RVS, KC_BTN3,                   KC_7,    KC_8,    KC_9,   KC_KP_PLUS, KC_KP_ASTERISK, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______, MACBACK, M_TAB_RVS, MACFW, _______, KC_PGUP,                      KC_4,    KC_5,    KC_6,   KC_KP_MINUS, KC_KP_SLASH, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______, MACUNDO, MACCUT,  MACCOPY, MACPASTE, KC_PGDN,                     KC_1,    KC_2,    KC_3,   _______, _______, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_MIRYOKU] = { ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN), ENCODER_CCW_CW(KC_WH_L, KC_WH_R)  },
    [_LOWER] =  { ENCODER_CCW_CW(KC_UP, KC_DOWN),              ENCODER_CCW_CW(KC_LEFT, KC_RIGHT) },
    [_RAISE] =  { ENCODER_CCW_CW(KC_WH_L, KC_WH_R),            ENCODER_CCW_CW(KC_VOLD, KC_VOLU)  },
